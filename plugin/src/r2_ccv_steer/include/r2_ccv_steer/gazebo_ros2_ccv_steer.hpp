...
/// A velocity plugin for gazebo. Based for the developed of the steering of 2 wheels.
/*
 *
...
/**
  ...
  \endcode
*/
class GazeboRos2CcvSteer : public gazebo::ModelPlugin
{
public:
  /// Constructor
  GazeboRos2CcvSteer();
...
private:
  ...
  std::unique_ptr<GazeboRos2CcvSteerPrivate> impl_;
};
}  // namespace gazebo_plugins
